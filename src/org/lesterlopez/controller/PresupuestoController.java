...
import org.lesterlopez.bean.Presupuesto;
...
public class PresupuestoController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        //Para que se coloque la fecha del dia actual
        fecha.getCalendarView().todayButtonTextProperty().setValue("Today");
        //Para que aparezca el numero de semana
        fecha.getCalendarView().setShowWeeks(false);
        fecha.getStylesheets().add("/org/lesterlopez/resource/TonysKinal.css");
        //Para que aparezca en el GridPane
        //3,0 La posicion de donde lo queremos
        grpFecha.add(fecha, 3, 0);
        //Para que se puedan ver los datos en el comboBox
    ...
    public void nuevo() {
        switch (tipoDeOperacion) {
            case NINGUNO:
                ...
                break;
            case GUARDAR:
                if (txtCantidadPresupuesto.getText().isEmpty() || fecha.selectedDateProperty().getValue() == null || cmbCodigoEmpresa.getSelectionModel().getSelectedItem() == "") {
                    ...
                    try {
                        ...
                        JOptionPane.showMessageDialog(null, "Por favor, ingresar datos numéricos en cantidad!!");
                    }
                }
                break;
        }
